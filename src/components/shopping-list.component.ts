    ...
    <div class="p-6">
      <div class="flex justify-between items-center mb-6">
        <div>
          ...
          <p class="text-gray-600">Organiza tus compras según el menú semanal</p>
        </div>
        <button
          (click)="generateList()"
      ...
      @if (!shoppingList()) {
        <div class="text-center py-12">
          ...
          <p class="text-gray-500 mb-4">Genera una lista basada en tu menú semanal</p>
          <button
            (click)="generateList()"
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white rounded-lg shadow-sm border p-6">
            <h3 class="text-lg font-semibold mb-4">Agregar ingrediente a la lista</h3>
            <form
          ...
          <div class="bg-white rounded-lg shadow-sm border">
            ...
            <div class="divide-y divide-gray-200">
              @for (item of shoppingList()!.items; track item.ingredientId; let i = $index) {
                <div
  ...
  async finalizePurchase(): Promise<void> {
    ...
    if (purchase) {
      this.showSuccessMessage(
        `¡Compra finalizada! Total: $${purchase.totalCost.toFixed(2)} - Inventario actualizado.`
      );
